...
public class UnfollowAsyncTask extends AsyncTask<User, Void, Boolean> {
	...
	public UnfollowAsyncTask(Activity activity) {
	...
	protected Boolean doInBackground(User... params) {
		...
		try {
			...
			String responseBody = HttpConnections.makeJsonPutRequest(
					...
					Constants.unfollowUri+user.getId(), jsonSend, null,
					activity);
